...
export default function Header() {
    ...
    useEffect(() => {
        const handleScroll = () => {
            setIsScrolled(window.scrollY > window.innerHeight/2); // Trigger background expansion after 50px scroll
        };
      ...
      `}</style>
            <header className="fixed top-0 left-0 flex justify-between items-center w-full px-[5%] my-[1%]">
                <div id="headerContainer" className="relative flex justify-between items-center w-full px-[1%]">
                    ...
                    <nav className="w-fit flex items-center gap-5 bg-white rounded-full px-4 py-2">
                        <NavigationMenu>
                            <NavigationMenuList>
                                <NavigationMenuItem>
                                ...
                                <NavigationMenuItem>
                                    <NavigationMenuTrigger className={"hover:text-blue-400"}>
                                    ...
                                    <NavigationMenuContent>
                                        <ul className="grid w-[600px] gap-3 p-4 md:w-[750px] md:grid-cols-3 lg:w-[900px]">
                                            ...
                                            <div>
                                                ...
                                                <ListItem href={"#"} title="See all >>" className={"text-blue-400"}>
                                ...
                                <NavigationMenuItem>
                                    <NavigationMenuTrigger className={"font-normal text-gray-700 hover:text-blue-400"}>
                                        Pain
                                    </NavigationMenuTrigger>
                                    <NavigationMenuContent>
                                    ...
                                    <li className="row-span-3">
                                        <NavigationMenuLink asChild>
                                            <Link href={"#"}>
                                                <div className="font-medium text-nowrap">Why Comprehensive Treatment</div>
                                            </Link>
                                        </NavigationMenuLink>
                                    </li> */}
                                ...
                                <NavigationMenuItem>
                                    <NavigationMenuTrigger>
                                        <Link href={"#"} title="Blogs" className={"font-normal"}>
                                            Blogs
                                        </Link>
                                    </NavigationMenuTrigger>
                                    <NavigationMenuContent>
                    ...
                    <div className="w-fit">
                        <button className="cursor-pointer flex items-center gap-5 bg-blue-400 text-white px-4 py-2 rounded-full">
