...
import { Image as ImageIcon, Camera, Palette } from 'lucide-react'; // Lucide icons for decorative elements
...
//   const textRef = useRef(null);
  ...
  return (
    <section
      ref={sectionRef}
      className="relative w-full h-[400px] md:h-[400px] flex items-center justify-center text-center overflow-hidden font-inter"
    >
      {/* Background Image with Subtle Overlay */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/galleryHero.png" // Muted, professional background image
        ...
        <div className="absolute inset-0 bg-gray-800/60 to-blue-900/60"></div> {/* Darker, muted overlay */}
      </div>
      ...
      <div ref={el => iconRefs.current[2] = el} className="absolute top-[40%] right-[20%] z-0 opacity-10 transform rotate-90">
        <Palette className="w-28 h-28 text-gray-300" />
      </div>
      ...
      <div className="relative z-10 text-white px-4 max-w-3xl mx-auto">
        ...
        <p ref={subtitleRef} className="text-lg md:text-xl font-medium mb-6 opacity-90 text-shadow-sm">
          Explore moments that define our commitment to care and excellence.
        </p>
